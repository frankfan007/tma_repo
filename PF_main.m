...
% First Particle filter implementation.
...
for mc = 1:MC        % monte carlo simulations
    ...
    Rinit   = 5300;
    model.m_init  = [Rinit*sin(zk_1(1)) 0 Rinit*cos(zk_1(1)) 0]';
    ...
    for k = 2:model.K       % total number of scans
        ...
        [xk_new, wk_new] = BootstrapPF(Xki, Wki, zk, model);
    ...
    scatter(GTruth.Ownship(1,:),GTruth.Ownship(3,:),'filled','ok')    % estimation result
