...
for mc = 1:MC
    ...
    EstCourse(mc,:) = atan2(Xest(2,:),Xest(4,:))*180/pi;
...
plot(mean(EstCourse,1),'r'), legend('True Course', 'Range Margins +,- 2^o', 'Estimated Course'), ylim([model.xCourse-10 model.xCourse+10]), hold off
